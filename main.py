...
def train_CE_Net_Vessel():
    ...
    image_root1 = '/data/baisr/bsisr/tumor/train/img/han_qiaoyan_2021906850_19800209_Female_Color_UWF_20201203134423_OS_20201203143202_-0.720000028610229_0.jpg'
    image_root2 = '/data/baisr/bsisr/tumor/train/img/jia_dingen_2012832096_19840902_Male_Color_Montage_20200702103426_OS_20200709133956_0.46000000834465_0.jpg'
    # img1 = cv2.imread(image_root1)
    # img1 = cv2.resize(img1, (448, 448))
    # img2 = cv2.imread(image_root2)
    # img2 = cv2.resize(img2, (448, 448))
    weight_path = './weights/CE_Net_NEW11FUSIONidridMABCELOSS.th'
    la = test_cenet.TTAFrame(CE_Net_NEW11, 2)
    la.load(weight_path)
    res1 = la.test_one_img_without_test_aug(image_root1)
    res2 = la.test_one_img_without_test_aug(image_root2)
    res1[res1 <= 0.5] = 0
    res1[res1 > 0.5] = 255
    res2[res2 <= 0.5] = 0
    res2[res2 > 0.5] = 255
    cv2.imwrite('/tmp/pycharm_project_368/tumres/1.png', res1)
    cv2.imwrite("/tmp/pycharm_project_368/tumres/2.png", res2)
